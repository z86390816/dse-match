...
for (const p of PROGRAMMES) {
  ...
  // PolyU 官方 200~350 尺度；CUHK 官方加權（best5 × 權重至 2 × 8.5）中位可達 ~70；其餘校 8~60
  const polyu = p.weightsStatus === 'official-polyu';
  const cuhk = p.weightsStatus === 'official-cuhk';
  const hiBound = polyu ? 360 : cuhk ? 72 : 60, loBound = polyu ? 80 : 8;
