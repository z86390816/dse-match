  ...
  return (
    <main className="layout">
      ...
      <section className="panel legal">
        <h2>{en ? 'Privacy Policy' : '私隱政策'}</h2>
        <p className="muted">{en ? 'Last updated: 2026' : '最後更新：2026 年'}</p>
        ...
        {en ? (
          <>
            ...
            <h3>5. Contact</h3>
            <p>For any questions about this policy, please reach us via the contact details on the site.</p>
          </>
        ) : (
          <>
            <h3>1. 我們收集的資料</h3>
