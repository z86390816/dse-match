...
const UNIVERSITIES = [
  { id: 'hku', name: '香港大學', en: 'The University of Hong Kong', short: 'HKU', gradeScheme: 'standard' },
  { id: 'cuhk', name: '香港中文大學', en: 'The Chinese University of Hong Kong', short: 'CUHK', gradeScheme: 'standard' },
  { id: 'hkust', name: '香港科技大學', en: 'The Hong Kong University of Science and Technology', short: 'HKUST', gradeScheme: 'standard' },
  { id: 'polyu', name: '香港理工大學', en: 'The Hong Kong Polytechnic University', short: 'PolyU', gradeScheme: 'standard' },
  { id: 'cityu', name: '香港城市大學', en: 'City University of Hong Kong', short: 'CityU', gradeScheme: 'standard' },
